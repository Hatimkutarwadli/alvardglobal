...
const contactItems = [
    ...
    { icon: Factory, title: "Factory Address", detail: "Tirupur, Tamil Nadu, India", href: "#" },
    ...
    { icon: Phone, title: "Phone", detail: "+91 93749 86852", href: "#" },
];
    ...
    return (
        <section id="contact" className="py-24 md:py-40 bg-card">
            <div className="section-padding max-w-7xl mx-auto">
                <div ref={ref} className={`transition-all duration-1000 mb-16 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
                            ...
                            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                <FormControl>
                                                    <Input placeholder="Your Name" {...field} className="bg-background border-border focus:border-primary h-12" />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                <FormControl>
                                                    <Input placeholder="Phone Number" {...field} className="bg-background border-border focus:border-primary h-12" />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormControl>
                                                <Input placeholder="Email Address" {...field} className="bg-background border-border focus:border-primary h-12" />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                ...
                                />
                                <Button type="submit" className="w-full sm:w-auto px-8 h-12 bg-primary hover:bg-primary/90 text-primary-foreground font-medium transition-all group">
                                    Send Message
